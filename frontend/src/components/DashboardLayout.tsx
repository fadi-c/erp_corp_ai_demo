...
import { MessageSquare, BarChart3, Github, LayoutDashboard } from "lucide-react"
...
export default function DashboardLayout() {
  ...
  const nav: NavItem[] = [
    ...
    { to: EXTERNAL_GRAFANA, label: "Grafana", icon: LayoutDashboard, credentials: "user: demo  pass: demo", external: true },
  ]
